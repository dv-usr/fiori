/**
 * 
 * @On(event = { "CREATE" }, entity = "sample_projectSrv.Redemptions")
...
module.exports = async function(request) {
    ...
    // Retrieve the current reward points and redeemed points of the customer
    ...
    if (customer.totalRewardPoints < redeemedAmount) {
        request.reject(400, "Insufficient reward points to redeem this amount");
        return;
    }
